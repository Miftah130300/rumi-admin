...
export interface ApiBannerArtikelBannerArtikel extends Struct.SingleTypeSchema {
  collectionName: 'banner_artikels';
  info: {
    displayName: 'BannerArtikel';
    pluralName: 'banner-artikels';
    singularName: 'banner-artikel';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::banner-artikel.banner-artikel'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiCityListCityList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imageCity: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    nameCity: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPartnerListPartnerList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imagePartner: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    namePartner: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPropertiProperti extends Struct.CollectionTypeSchema {
  collectionName: 'propertis';
  info: {
    description: '';
    displayName: 'Properti';
    pluralName: 'propertis';
    singularName: 'properti';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    imageProperty: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    jenisSertifikat: Schema.Attribute.String;
    jumlahKamarMandi: Schema.Attribute.String;
    jumlahKamarTidur: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::properti.properti'
    > &
      Schema.Attribute.Private;
...
export interface ApiTestimonyTestimony extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pesanTestimoni: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::properti.properti': ApiPropertiProperti;
